...
func scrapeFeed(db *database.Queries, wg *sync.WaitGroup, feed database.Feed) {
	...
	for _, item := range rssFeed.Channel.RSSFeedItems {
		...
		if err != nil {
			...
			log.Println("It couldn't create the post feed:", err)
		}
	}
	log.Printf("Feed %s collected, %v posts found", feed.Name, len(rssFeed.Channel.RSSFeedItems))
}
